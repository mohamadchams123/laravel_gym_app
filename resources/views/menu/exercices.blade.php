    ...
    <div class="p-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="py-3">
                    <x-exercise-category value="Chest Exercises" image="chest">
                    ...
                    <x-exercise-category value="Shoulders Exercises" image="shoulders">
                    ...
                    <x-exercise-category value="Back Exercises" image="back">
                    ...
                    <x-exercise-category value="Biceps Exercises" image="biceps">
                    ...
                    <x-exercise-category value="Triceps Exercises" image="triceps">
                    ...
                    <x-exercise-category value="Leg Exercises" image="legs">
                    ...
                    <x-exercise-category value="Core Exercises" image="core">
                    ...
                    <x-exercise-category value="Cardio Exercises" image="cardio">
                    ...
                    <x-exercise-category value="Flexibility and Mobility Exercises" image="flexibility">
